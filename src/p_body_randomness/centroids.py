...
def extract_centroids(pbodies_image: np.ndarray, area_threshold = 5):
    ...
    im2, contours, hierarchy = cv2.findContours(pbodies_binary,cv2.RETR_TREE,cv2.CHAIN_APPROX_SIMPLE)
...
def extract_centroids_in_sample_area(pbodies_image: np.ndarray, sample_mask: np.ndarray, area_threshold = 5):
...
# pbodies_img = cv2.imread('/Users/Joel/p-body-randomness/data/input_data/20180606-SLP_Multiplexing_p1_C03_x000_y000_z000_t000_13_Pbody_Segm_Label14.png', 0)
# img_dapi = cv2.imread('/Users/Joel/p-body-randomness/data/input_data/20180606-SLP_Multiplexing_p1_C03_x000_y000_z000_t000_2_DAPI_Label14.png', 0)
# cell_mask = cv2.imread('/Users/Joel/p-body-randomness/data/input_data/20180606-SLP_Multiplexing_p1_C03_x000_y000_z000_t000_segmentation_Label14.png', 0)
